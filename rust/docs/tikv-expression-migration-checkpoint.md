...
| `compare-predicate-{lib-final3,all-final3,diffs-final4,runtime-final,session-copying-final3,session-native-final3,integration-native-final2,integration-copying-final2}.log` | 1181 library + 77 external passed; expression/query diffs passed; runtime 319 receipts / 2062 engine rows / 160 borrowed rows; session Copying 334 passed / 4 carried failed, feature-off 332 passed / 4 carried failed; broad Native 176 divergences, Copying 167 / 416271 engine rows | Native ISNULL/IP kernels and prepared-point residual are absent; admitted column shapes have engine value oracles and positive counters; affected source tests explicitly verify contractions. |
