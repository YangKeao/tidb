...
pub(crate) const ADMISSION_ROWS: &[AdmissionRow] = &[
    ...
    row("bin_to_uuid", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    ...
    row("format_bytes", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    row("format_nano_time", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    ...
    row("is_uuid", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    ...
    row("name_const", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    ...
    row("uuid", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    row("uuid_short", Decision::Excluded, Signature::None, &[], Shape::Any, NOT_TRIAGED),
    row("uuid_timestamp", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    row("uuid_to_bin", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    row("uuid_v4", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    row("uuid_v7", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    row("uuid_version", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
    ...
    row("vitess_hash", Decision::Excluded, Signature::None, &[], Shape::Any, REMOVED_MISC_UNSUPPORTED),
