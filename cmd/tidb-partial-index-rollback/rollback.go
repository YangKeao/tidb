...
func (r *runner) rollbackOperations() []rollbackOperation {
	...
	add(r.sqlOperation(245, "restore mysql.bind_info.original_sql to TEXT",
		`ALTER TABLE mysql.bind_info MODIFY COLUMN original_sql TEXT NOT NULL`))
	add(r.sqlOperation(245, "restore mysql.bind_info.bind_sql to TEXT",
		`ALTER TABLE mysql.bind_info MODIFY COLUMN bind_sql TEXT NOT NULL`))
